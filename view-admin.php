    ...
    <!-- Breadcrumb-->
     <div class="row pt-2 pb-2">
       ...
       <div class="btn-group float-sm-right">
          ...
          <div class="card">
            <div class="card-body">
                <h5 class="card-title"><i class="fa fa-table">  </i>  <a href="add-admin.php">Add Admin Details</a></h5>
              ...
              <table class="table table-bordered">
                ...
                while($adminrow = mysqli_fetch_array($selectq))
                {
                    ...
                    echo "<td><a href = ''><img style='width:16px;' src='assets/images/icon/edit-icon.png'>Edit </a> | <a Onclick='return ConfirmDelete();' href = 'view-admin.php?did={$adminrow['admin_id']}'><img style='width:16px;' src='assets/images/icon/delete-icon.png'>Delete</a></td>";
                    echo "</tr>";
