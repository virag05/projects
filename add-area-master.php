  ...
  <div class="content-wrapper">
    ...
    <div class="row">        <div class="col-lg-1"></div>
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
               <div class="card-title text-dark"><h4>Area Master</h4></div>
           <hr>
            <form method="POST" enctype="multipart/form-data">
        
           <div class="form-group">
            <label for="input-2">Area Name</label>
            <input type="text" class="form-control"  required="true" name="aname" id="input-2" placeholder="Enter Area">
           </div>
         
         
          <div class="form-group">
          <button type="submit" class="btn btn-gradient-royal shadow-primary px-5">Submit</button>
          <button type="button" class="btn btn-gradient-orange shadow-success px-5" onclick="window.location='view-area-master.php'; " name="button">view</button>
