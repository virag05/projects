  ...
  <div class="content-wrapper">
    ...
    <div class="row"> <div class="col-lg-1"></div>
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
               <div class="card-title text-dark"><h4>Venue Inquiry</h4></div>
           <hr>
          ...
          <?php 
                                            ...
                                            $venq = mysqli_query($connection, "select * from tbl_venue_master") or die(mysqli_error($connection));
                                              ...
                                              echo "<select name='ven' class='form-contol'>";
           ...
           <div class="form-group">
            ...
            <input type="date" name="date" required="true" class="form-control" id="input-4" placeholder="choose Date">
           </div>
                 <div class="form-group">
            <label for="input-4">Slot</label>
           ...
           <div class="form-group">
               ...
               <input type="text" name="status" required="true" class="form-control" id="input-4" placeholder="choose Date">
           </div>
          <div class="form-group">
          <button type="submit" class="btn btn-gradient-royal shadow-primary px-5">Submit</button>
         <button type="button" class="btn btn-gradient-orange shadow-success px-5" onclick="window.location='view-venue-inquiry.php';" name="button">view</button>
