  ...
  <div class="content-wrapper">
    ...
    <div class="row"><div class="col-lg-1"></div>
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
               <div class="card-title text-dark"><h4>REVIEW</h4></div>
           <hr>
           ...
           <div class="form-group">
            <label for="input-4">Review</label>
            <input type="text" name="review" required="true" class="form-control" id="input-4" placeholder="">
           </div>
                              <div class="form-group">
         ...
         <button type="button" class="btn btn-gradient-orange shadow-success px-5" onclick="window.location='view-venue-review.php';" name="button">view</button>
